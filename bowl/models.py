...
class Locker(models.Model):
    ...
    name = models.CharField(max_length=10, null=True)  # 사용자 이름
    club = models.CharField(max_length=11, null=True, blank=True)  # 소속 클럽
    phone_number = models.CharField(max_length=20, null= True, blank=True)
    effective_date = models.DateField() # 락커 유효일자 (계약이 시작되는 일자)
    expiration_date = models.DateField()    # 락커 만료일자 (계약이 끝나는 일자)
